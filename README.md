...
Note that in order to run the whole test suite, i.e. including differential fuzzing tests, the [`dissig`](https://github.com/chronicleprotocol/dissig) and oracle-suite's [`schnorr`](https://github.com/chronicleprotocol/oracle-suite) binaries need to be present inside the `bin/` directory.
